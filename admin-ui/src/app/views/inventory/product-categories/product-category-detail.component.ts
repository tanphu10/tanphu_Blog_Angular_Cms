...
import { AdminApiPostCategoryApiClient, AdminApiProductCategoryApiClient, PostCategoryDto } from '../../../../app/api/admin-api.service.generated';
...
export class ProductCategoryDetailComponent implements OnInit, OnDestroy {
    ...
    private saveData() {
        if (this.utilService.isEmpty(this.config.data?.id)) {
            this.productCategoryService.createProductCategory(this.form.value)
                .pipe(takeUntil(this.ngUnsubscribe))
                .subscribe(() => {
            ...
            this.productCategoryService.updateProductCategory(this.config.data.id, this.form.value)
                .pipe(takeUntil(this.ngUnsubscribe))
                .subscribe(() => {
                    this.toggleBlockUI(false);
                    this.ref.close(this.form.value);

...
export class AdminApiAnnouncementApiClient {
     ...
     * @return Success
     */
    userAnnoucement(id: string): Observable<AnnouncementViewModel> {
        let url_ = this.baseUrl + "/api/admin/annoucement/user-annoucements/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUserAnnoucement(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUserAnnoucement(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<AnnouncementViewModel>;
                }
            } else
    ...
    protected processUserAnnoucement(response: HttpResponseBase): Observable<AnnouncementViewModel> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getTopMyAnnouncement(pageIndex?: number | undefined, pageSize?: number | undefined): Observable<AnnouncementViewModelPageResult> {
    ...
    protected processGetTopMyAnnouncement(response: HttpResponseBase): Observable<AnnouncementViewModelPageResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiTaskApiClient {
     ...
     * @return Success
     */
    getTopMyTaskNotifications(pageIndex?: number | undefined, pageSize?: number | undefined): Observable<TaskNotificationViewModelPageResult> {
        let url_ = this.baseUrl + "/api/admin/tasks/get-top-task-notifications?";
        if (pageIndex === null)
            throw new Error("The parameter 'pageIndex' cannot be null.");
        else if (pageIndex !== undefined)
            url_ += "pageIndex=" + encodeURIComponent("" + pageIndex) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTopMyTaskNotifications(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTopMyTaskNotifications(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<TaskNotificationViewModelPageResult>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TaskNotificationViewModelPageResult>;
        }));
    }

    protected processGetTopMyTaskNotifications(response: HttpResponseBase): Observable<TaskNotificationViewModelPageResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TaskNotificationViewModelPageResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    markAsTaskRead(announId?: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/tasks/mark-read?";
        if (announId === null)
            throw new Error("The parameter 'announId' cannot be null.");
        else if (announId !== undefined)
            url_ += "announId=" + encodeURIComponent("" + announId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processMarkAsTaskRead(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMarkAsTaskRead(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processMarkAsTaskRead(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    userTaskNotification(id: string): Observable<TaskNotificationViewModelPageResult> {
        let url_ = this.baseUrl + "/api/admin/tasks/user-annoucements/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUserTaskNotification(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUserTaskNotification(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<TaskNotificationViewModelPageResult>;
                }
            } else
    ...
    protected processUserTaskNotification(response: HttpResponseBase): Observable<TaskNotificationViewModelPageResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    assignToUser(taskId?: string | undefined, body?: AssignToUserRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/tasks/assign-task-user?";
        if (taskId === null)
     ...
     * @return Success
     */
    getAllUserTask(userId?: string | undefined): Observable<TaskInListDto> {
        let url_ = this.baseUrl + "/api/admin/tasks/task-all-user?";
        if (userId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllUserTask(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllUserTask(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<TaskInListDto>;
                }
            } else
    ...
    protected processGetAllUserTask(response: HttpResponseBase): Observable<TaskInListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TaskInListDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class TaskNotificationViewModel implements ITaskNotificationViewModel {
    taskId?: string;
    userBy?: string;
    content?: string | undefined;
    userName?: string | undefined;
    ...
    constructor(data?: ITaskNotificationViewModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TaskNotificationViewModel {
        data = typeof data === 'object' ? data : {};
        let result = new TaskNotificationViewModel();
        result.init(data);
        return result;
    }
...
export interface ITaskNotificationViewModel {
    taskId?: string;
    userBy?: string;
    content?: string | undefined;
    userName?: string | undefined;
...
export class TaskNotificationViewModelPageResult implements ITaskNotificationViewModelPageResult {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
    ...
    readonly lastRowOnPage?: number;
    additionalData?: number | undefined;
    results?: TaskNotificationViewModel[] | undefined;

    constructor(data?: ITaskNotificationViewModelPageResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["results"])) {
                this.results = [] as any;
                for (let item of _data["results"])
                    this.results!.push(TaskNotificationViewModel.fromJS(item));
            }
        }
    }

    static fromJS(data: any): TaskNotificationViewModelPageResult {
        data = typeof data === 'object' ? data : {};
        let result = new TaskNotificationViewModelPageResult();
        result.init(data);
        return result;
    }
...
export interface ITaskNotificationViewModelPageResult {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;

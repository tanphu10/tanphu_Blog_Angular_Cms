...
export class AdminApiPostApiClient {
    ...
    protected processGetAllPost(response: HttpResponseBase): Observable<PostDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiRoleApiClient {
     ...
     * @return Success
     */
    getAllRole(): Observable<RoleDtoPageResult> {
    ...
    protected processGetAllRole(response: HttpResponseBase): Observable<RoleDtoPageResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;

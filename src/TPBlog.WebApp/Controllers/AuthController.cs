...
using TPBlog.Core.Events.RegisterSuccessed;
...
namespace TPBlog.WebApp.Controllers
{
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            TempData[SystemConstants.FormSuccessMsg] = "You need to check mail to reset password";
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                TempData[SystemConstants.FormSuccessMsg] = "Reset password successful";
                return Redirect(UrlConsts.Login);
            }
            return View();
        }

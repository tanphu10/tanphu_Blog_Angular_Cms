...
builder.Configuration.AddJsonFile("appsettubgs.json", optional: true, reloadOnChange: true).AddJsonFile($"appsetings.{builder.Environment.EnvironmentName}.json", optional: true);

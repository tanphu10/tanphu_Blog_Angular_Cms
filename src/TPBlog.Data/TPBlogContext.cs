...
namespace TPBlog.Data
{
    public class TPBlogContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<IdentityUserLogin<Guid>>().ToTable("AppUserClaims").HasKey(x => x.UserId);
            builder.Entity<IdentityUserRole<Guid>>().ToTable("AppUserClaims").HasKey(x => new { x.RoleId, x.UserId });
            builder.Entity<IdentityUserToken<Guid>>().ToTable("AppUserClaims").HasKey(x => new { x.UserId });
        }
